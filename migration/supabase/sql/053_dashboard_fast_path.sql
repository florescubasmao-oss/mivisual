...
-- Fast path: el listado del Dashboard no materializa detProduccion completo.
-- El detalle queda disponible bajo demanda en mv_dashboard_produccion_detalle.
...
select
  ...
  jsonb_build_object(
    ...
    'totalPuntos',round(r.produccion,2),
