...
async function renderPET(admin:any,a:any,d:any){
  ...
  cell(p,f.b,"EQUIPO DE PROTECCIÓN REQUERIDO",M,top+2,W-M*2,12,{z:5.7,center:true,fill:HEAD});box(p,M,top+14,W-M*2,28);(d.epp||[]).forEach((v:string,i:number)=>text(p,f.i,"× "+v,M+5+(i%3)*(W-M*2-10)/3,top+15+Math.floor(i/3)*6.2,(W-M*2-10)/3,6.2,{z:5.2,c:BLUE}));top+=42;
