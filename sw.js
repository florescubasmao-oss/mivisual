/* MI VISUAL V350 - caché segura, escalas y bono total editable */
const MV339_CACHE = "mivisual-v350-bono-total-editable-20260805";
const MV339_CORE = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./js/modulos_loader.js?v=V350-BONO-TOTAL-EDITABLE",
