/* ============================================================
   MI VISUAL V517C.12 - PUENTE GAR/VTR
   ...
   V517C.10/V517C.11 dejan de cargarse para evitar una segunda presentación
   del mismo caso sobre la vista operativa que ya está funcionando.
...
(function(){
  ...
  cargar("./js/vtr_gar_ux_v517c3.js?v=V517C3-UX-RAPIDA-20260828-1","MV517C3_UX_RAPIDA_OK")
    ...
    .then(()=>console.log("MI VISUAL V517C.12: GAR/VTR compacto cargado."))
    .catch(e=>console.error("MI VISUAL V517C.12: error de carga",e));
})();
