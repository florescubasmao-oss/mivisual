/* MI VISUAL V487.3 - Vista paralela de Produccion WIN. No realiza escrituras. */
(function(){
  "use strict";
  ...
  function cargarReglasVtrGar(){
    ...
    MV487_GATE_PROMESA=cargarScript("./js/produccion_vtr_gar_gate_v4872.js?v=V4872-SIN-REPORTE-CERO-PUNTOS",function(){return typeof window.mv4872AplicarReglaVtrGar==="function";},"No se pudo activar la regla VTR/GAR V487.2.")
      .then(function(){return cargarScript("./js/produccion_vtr_gar_origen_v4873.js?v=V4873-PROPIA-ASIGNADA",function(){return typeof window.mv4873AplicarOrigenVtrGar==="function";},"No se pudo activar la clasificación PROPIA/ASIGNADA V487.3.");})
  ...
  function render(r){
    ...
    document.getElementById("pw487Estado").innerHTML=`<div class="pw487-alert"><b>Modo paralelo V487.3 · solo lectura</b><br>Calculado ${esc(r.calculadoAl)}. No se modificó Producción oficial ni ningún otro indicador.</div><div class="pw487-rule"><b>Regla VTR/GAR:</b> toda VTR/GAR FINALIZADA de WIN aparece en el historial diario. <b>ASIGNADA:</b> si fue reportada por el técnico, se habilita automáticamente salvo registro rechazado/observado. <b>PROPIA:</b> debe estar reportada y validada BONO. <b>Sin reporte o origen MANUAL = 0 puntos.</b> El indicador se atribuye a la cuadrilla de la atención anterior.</div>`;
    document.getElementById("pw487Kpis").innerHTML=[
      ...
      kpi("VTR/GAR SIN REPORTE",x.vtrGarSinReporte||0),kpi("VTR/GAR HABILITADAS",x.vtrGarHabilitadas||0),kpi("VTR/GAR NO CONSID.",x.vtrGarNoConsideradas||0),
    ...
    document.getElementById("pw487Meta").textContent=`Entrenamiento: ${r.periodoEntrenamiento} · ${r.reglas.filasEntrenamiento} coincidencias válidas · Catálogo vigente sin cambios · Reglas VTR/GAR V487.3 aplicadas en lectura.`;
    renderDetalle("TODAS");
  }
  ...
  async function consultar(){
    ...
    try{
      btn.disabled=true;estado.innerHTML="Calculando Producción WIN paralela, reportes y origen PROPIA/ASIGNADA...";
