...
(function(){
  ...
  function guardarLocal(periodo,data){
    try{localStorage.setItem(claveLocal(periodo),JSON.stringify({ts:Date.now(),data:data}));}catch(_){}
  }
