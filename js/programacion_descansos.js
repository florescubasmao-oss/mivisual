...
function pdRenderGestion(){
  ...
  const alertasJefatura=esSupervisor?PD_DATA.programacion.filter(x=>pdNorm(x.estadoProgramacion)==='APROBADO'&&pdNorm(x.resultadoJefatura)==='APROBADO'&&x.solicitadoPor&&pdNorm(x.solicitadoPor)!==pdNorm(u.usuario)):[];
