// MI VISUAL - Programación de Descansos V125
  ...
  try{
    ...
    function evaluar(plataforma,dia){
      ...
      if(esSupervisor&&total===3){
        ...
        return{plataforma,total,campo,porcentaje,estado,aplica:false,tipo:'TRES',objetivo:3,minimo:2,objetivoPct:Math.round(regla.objetivo*100),alerta};
      }
      if(esSupervisor&&total===4){
        const alerta=campo<3;
        const estado=alerta?'rojo':'verde';
        return{plataforma,total,campo,porcentaje,estado,aplica:false,tipo:'CUATRO',objetivo:4,minimo:3,objetivoPct:Math.round(regla.objetivo*100),alerta};
      }
