...
(function(){
  ...
  */
  cargar("./js/indicadores_win_sync_v4879.js?v=V552-RECUPERACION-INDICADORES-20260921-1")
    .then(()=>cargar("./js/mapa_indicadores_estado_v544.js?v=V552-RECUPERACION-INDICADORES-20260921-1"))
    .then(()=>cargar("./js/mapa_indicadores_watchdog_v545.js?v=V552-RECUPERACION-INDICADORES-20260921-1"))
