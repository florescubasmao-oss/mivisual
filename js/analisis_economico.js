...
function aeAlertaSinTarifa(data){
  ...
  const total=detalles.length||codigos.length;return`<div class="ae-aviso"><b>Atención:</b> No se pudo valorizar ${total} registro(s) porque el código no tiene tarifa activa.<div class="ae-aviso-codigos">${filas}</div></div>`
}
