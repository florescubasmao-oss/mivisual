/* ============================================================
   MI VISUAL V442 - SEGURIDAD ATS / PETAR DIGITAL - INGRESO GUIADO
...
const LOGO_EMPRESA='./img/logo-visual-connections.png?v=V442';
...
function cacheKey(){return 'MI_VISUAL_SEG442_CTX_'+N(user())}
function cacheLeer(){
  try{
