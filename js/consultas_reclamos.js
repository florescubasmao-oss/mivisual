...
async function crDetalle(id){
  try{
    ...
    const controles=finalizado
      ? `<div class="cr-final-note">Caso finalizado. El estado ya no puede modificarse ni admite nuevas respuestas.</div>`
